<%@ Page Title="" Language="C#" MasterPageFile="~/human_force/human_force.Master" AutoEventWireup="true" CodeBehind="manpower.aspx.cs" Inherits="aswan_stats.human_force.manpower" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">طاقة المحافظة البشرية</h1>
            </div>
        </div>
        <!-- /.row -->
        <div class="column">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="form">
                        <form runat="server">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-right control-label col-form-label">سنة الحصول</label>
                                    <asp:TextBox runat="server" type="number" class="form-control" ID="date" name="date"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name" class="text-right control-label col-form-label">عدد الخريجين الذكور</label>
                                    <asp:TextBox runat="server" type="number" class="form-control" ID="g_male"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name" class="text-right control-label col-form-label">عدد الخريجين الاناث</label>
