<%@ Page Title="" Language="C#" MasterPageFile="~/human_force/human_force.Master" AutoEventWireup="true" CodeBehind="appointed.aspx.cs" Inherits="aswan_stats.human_force.appointed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">المعينين بالمكتب</h1>
            </div>
        </div>
        <!-- /.row -->
        <div class="column">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="form">
                        <form runat="server">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-right control-label col-form-label">سنة التعين</label>
